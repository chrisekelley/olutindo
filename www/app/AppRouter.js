    ...
    searchResults.fetch({fetch: 'query',
        ...
        success: function(collection, response, options) {
          ...
          var homeView = new HomeView(
            ...
            {model: page, endkey:endkey});
          FORMY.RegionManager.show(homeView);
        }}
    );
  },
...
//              }
  ...
  config: function () {
    ...
    //(new ConfigView({model: page})).render()
    var configView = new ConfigView({model: page});
    FORMY.RegionManager.show(configView);
  },
  populate: function () {
