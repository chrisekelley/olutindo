...
window.Hoodie = window.Hoodie || (function(_super) {
  ...
  function Hoodie(baseUrl) {
    ...
    console.log("checkConnection in new Hoodie instance at " + baseUrl)
    this.checkConnection();
    console.log("finished checkConnection.")
  }
  ...
  Hoodie.prototype.request = function(type, url, options) {
    ...
    //console.log("trying to hit the remote server: " + url);
    requestPromise = $.ajax($.extend(defaults, options));
    //console.log("now trying to pipe the request and then see its error.")
  ...
  Hoodie.prototype.checkConnection = function() {
    ...
    if (req && req.state() === 'pending') {
      console.log("checkConnection: request is pending")
      return req;
    }
  ...
  Hoodie.prototype._pipeRequestError = function(xhr) {
    ...
    try {
      ...
      console.log("_handleCheckConnectionError: " + JSON.stringify(error))
    } catch (_error) {
      error = {
...
Hoodie.Remote = (function(_super) {
  ...
  Remote.prototype.save = function(type, id, object) {
    ...
    if (!id) {
      id = this.hoodie.uuid();
      console.log("id assigned using Remote uuid function: " + id);
    }
    object = $.extend({
      type: type,
      id: id
